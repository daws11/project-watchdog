  ...
  const sidebarContent = (collapsed: boolean) => (
    <div className="flex flex-col h-full">
      ...
      <div className={cn('px-5 py-5', collapsed && 'px-2 py-5 flex justify-center')}>
        {collapsed ? (
          <span className="text-lg font-bold text-zinc-900 dark:text-zinc-100 font-heading">
            W
          </span>
        ) : (
          <span className="text-lg font-bold tracking-tight text-zinc-900 dark:text-zinc-100 font-heading">
            Watchdog
          </span>
        )}
      </div>
    ...
    <div className="@container flex h-screen bg-white dark:bg-zinc-950">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="flex items-center gap-3 px-4 py-3 border-b border-zinc-200 dark:border-zinc-800 @3xl:hidden">
          ...
          <span className="text-base font-bold tracking-tight text-zinc-900 dark:text-zinc-100 font-heading">
            Watchdog
          </span>
        </header>
